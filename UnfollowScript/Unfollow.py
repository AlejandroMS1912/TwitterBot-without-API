...
class TwitterBot:
    ...
    def unfollow(self, username):
        ...
        for n in lista_arr_def:
            ...
            if cont_unfollows <= 19:
                cont_unfollows += 1
                print("You have " + str(cont_unfollows) + " consecutive unfollows, " 
                        + str(20 - cont_unfollows) + " left for the next break (20 min)")
...
UserParameters.unfollow('Probando2847') # ('username')
